...
<div id="expresscurate_widget_wrapper"
    ...
    <label><?php _e('Keywords '); ?><span class="rotate"><a href="#"></a></span>
        <span class="mark"><span><?php _e('mark keywords');?></span></span>
    </label>
    <?php
...
if ($seo) {
    ...
    <div class="description">
        ...
        <div class="hint expresscurate_displayNone borderRight">
            <span><?php _e('characters left');?></span>

            <p class="lettersCount"><span class="bold">156</span> / 156</p>
            <span class="tooltip"><?php _e('The meta description will be limited to 156 chars.');?></span>
        </div>
        <div class="hint expresscurate_displayNone">
            <span>keywords</span>

            <p class="usedKeywordsCount"><span class="bold">0</span> / 0</p>
            <span class="tooltip"><?php _e('It\'ll be better to use keywords in meta description.');?></span>
        </div>

        <p class="expresscurate_displayNone"><?php _e('The meta description tag is intented to be a brief and concise summary of
            your
            page\'s content.');?></p>
    </div>

    <a href="#" class="expresscurate_moveToAdvanced"><?php _e('Advanced SEO');?></a>
<?php } ?>
<script type="text/html" id="tmpl-SEOControlCenter">
    <div class="expresscurate_background_wrap expresscurate_preventTextSelection">
        ...
        <div class="statistics {{data.inTitle}} borderRight">
            <div class="center"><?php _e('title');?></div>
        </div>
        <div class="statistics">
            <div class="center"><?php _e('content');?><span>{{data.inContent}}%</span></div>
        </div>
    </div>
</script>
