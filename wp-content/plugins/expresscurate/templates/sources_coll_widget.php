...
<div class="expresscurate_sources_coll_widget expresscurate_Styles">
    <ul>
        ...
        if(!empty($items)){
            foreach ($items as $key => $item) {
                ...
                <textarea name="expresscurate_sources[<?php echo $key ?>]"
                    ...
                    <div class="hover">
                        <a class="curate expresscurate_curate"><?php _e('Curate'); ?></a><a class="delete">
                <?php _e('Delete'); ?></a>
                  <span class="tooltip">
                    <p><?php _e('Collected from'); ?></p>
        ...
        <!--add new-->
        <li class="addSource">
            <span class="text"><?php _e('+ Add new source'); ?></span>
    ...
    <script type="text/html" id="tmpl-sourceCollWidget">
        <li class="list">
            ...
            <div class="hover">
                <a class="curate expresscurate_curate"><?php _e('Curate'); ?></a><a class="delete"><?php _e('Delete'); ?></a>
                            <span class="tooltip">
                                <p><?php _e('Collected from'); ?></p>
