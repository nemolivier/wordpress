            ...
            <div class="header">
                <div class="addressbar">
                    ...
                    <input type="text" class="expresscurate_load"
                           ...
                           value="<?php echo @get_post_meta($post->ID, 'expresscurate_source', true); ?>">
                    <button class="load" id="expresscurate_submit"><?php _e('Load'); ?></button>
                    <button class="load expresscurate_displayNone" id="expresscurate_clone"><?php _e('Clone') ?></button>
                </div>
                <div class="title">
            ...
            <div class="content">
                ...
                <div class="left imgContainer">
                    <div class="imgIcons">
                        ...
                        <div class="sizeM">
                            <div class="tooltipWrap">
                                <span><?php _e('Middle size'); ?></span>
                            </div>
                        </div>
                        <div class="sizeS">
                            <div class="tooltipWrap">
                                <span><?php _e('Small size'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="alignleft imgAlign">
                            <div class="tooltipWrap">
                                <span><?php _e('Align left'); ?></span>
                            </div>
                        </div>
                        <div class="alignnone active imgAlign">
                            <div class="tooltipWrap">
                                <span><?php _e('Fit to center'); ?></span>
                            </div>
                        </div>
                        <div class="alignright imgAlign">
                            <div class="tooltipWrap">
                                <span><?php _e('Align right') ?></span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="footer">
            ...
            <ul class="labels" id="curated_tags">
                <li class="markButton expresscurate_displayNone expresscurate_preventTextSelection">
                    <span><?php _e('mark keywords'); ?></span></li>
            </ul>
            <div class="clear"></div>
...
<script type="text/html" id="tmpl-dialogMarkButton">
    <li class="markButton expresscurate_preventTextSelection"><span><?php _e('mark keywords'); ?></span></li>
</script>
...
<script type="text/html" id="tmpl-dialogSearchParagraphs">
    <li class="expresscurate_preventTextSelection expresscurate_dialog_shortPar expresscurate_shortParInactiveColor">
        <label><?php _e('Short Paragraphs'); ?></label>
...
<script type="text/html" id="tmpl-dialogCuratedDescription">
    <li id="curated_description" title="{{data}}"><?php _e('Description'); ?></li>
</script>
