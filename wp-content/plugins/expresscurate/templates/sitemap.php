    ...
    <ul>
        <li>
            <div class="title submitSitemapWrap">
                <a class="generate <?php if (strlen(get_option('expresscurate_google_refresh_token')) < 3) {
                    echo 'expresscurate_displayNone';
                } else {
                    echo 'generated';
                } ?>" id="submitSiteMap" href="#"><?php _e('Submit Sitemap'); ?><span class="loading"></span></a>
            </div>
            <a class="generate" id="generateSiteMap" href="#"><?php _e('Generate Sitemap'); ?></a>
        </li>
        <br/>
        <li>
            <p class="title"><?php _e('Sitemap update frequency'); ?><span
                    class="description "><?php _e('How often should the sitemap be updated?'); ?></span></p>
        ...
        <li>
            <p class="title"><?php _e('Include all new posts in sitemap?'); ?><span class="description "><?php _e('All new posts will be included in your sitemap if this option is enabled'); ?></span>
            </p>
        ...
        <li>
            <p class="title"><?php _e('Include all new pages in sitemap?'); ?><span class="description "><?php _e('All new pages will be included in your sitemap if this option is enabled'); ?></span>
            </p>
        ...
        ?>
        <li>
            <p class="title"><?php _e('Sitemap manual priority value'); ?><span class="description "><?php _e('Please select the priority for new posts in your sitemap'); ?></span>
            </p>
            <select class="controls" id="expresscurate_sitemap_priority_manual_value"
                    name="expresscurate_sitemap_priority_manual_value">
        ...
        <li>
            <p class="title"><?php _e('Sitemap default changefreq'); ?><span class="description "><?php _e('Please select the sitemap changefreq value for your new posts'); ?></span>
            </p>
        ...
        <li>
            <p class="title"><?php _e('Sitemap archiving frequency'); ?><span class="description "><?php _e('Please select the frequency of archiving old post definitions in the sitemap'); ?></span>
            </p>
        ...
        <li class="expresscurate_sitemap_webmasters">
            <p class="title"><?php _e('Submit sitemap automatically?'); ?><span class="description "><?php _e('If this option is enabled, sitemap will be submitted to webmaster tools of search engines automatically.'); ?></span>
            </p>
        ...
        <li>
            <div class="sitemapUpdateFrequency <?php if (get_option('expresscurate_sitemap_submit') != 'on') {
                echo 'expresscurate_displayNone';
            } ?> />">
                <p class="title"><?php _e('Registered domain in Google Search Console (aka Webmaster Tools)'); ?><span
                        class="description"><?php _e('Specify if different from blog address'); ?></span></p>
                <input class="controls" type="text" name="expresscurate_sitemap_domain" id="expresscurate_sitemap_domain"
                       value="<?php echo get_option('expresscurate_sitemap_domain',''); ?>" placeholder="<?php echo get_site_url(); ?>">
                <br>
                <p class="title"><?php _e('Sitemap submission frequency'); ?><span class="description "><?php _e('How often should sitemap be submitted to search engines?'); ?></span>
                </p>
                ...
                ?>
                <a class="getApiKey  <?php if (strlen(get_option('expresscurate_google_refresh_token')) > 2) {
                    echo 'expresscurate_displayNone';
                } ?>"
                   href="https://www.expresscurate.com/api/connector/google/webmasters/refreshtoken/<?= $blogName ?>"><?php _e('Authorize
                    access to Google Search Console (aka Webmaster Tools)'); ?></a>
            </div>
        </li>
    </ul>
