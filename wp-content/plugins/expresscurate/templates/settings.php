<div class="expresscurate expresscurate_Styles expresscurate_settings wrap">
    ...
    <h2 class="expresscurate_displayNone"><?php _e('Settings'); ?></h2>
    <?php
    ...
    <ul class="tabs" data-currenttab="<?php echo $_SESSION['settings_current_tab'] ?>">
        <li class="tab-link expresscurate_preventTextSelection green current" data-tab="tab-1"><?php _e('General'); ?></li>
        <li class="tab-link expresscurate_preventTextSelection orange" data-tab="tab-5"><?php _e('Feed'); ?></li>
        <li class="tab-link expresscurate_preventTextSelection red" data-tab="tab-2"><?php _e('Smart publishing'); ?></li>
        <li id="sitemapTab"
        ...
        <li class="tab-link expresscurate_preventTextSelection yellow" data-tab="tab-4"><?php _e('Extension'); ?></li>
    </ul>
    ...
    <div id="tab-1" class="tab-content current">
        <div>
            <form class="expresscurate_marginTop20" method="post" action="options.php">
                ...
                <ul>
                    <li>
                        <div class="title"><?php _e('Image Placement'); ?>
                            <div class="description">
                                <?php _e('There are two options for placing the images (picked from the original article) in your
                                curated post:'); ?>
                                <ol>
                                    <li><?php _e('Featured. The image will be placed above the title, at the very top of your
                                        post. This will give
                                        your image a more prominent look.'); ?>
                                    </li>
                                    <li><?php _e('Standard. The image will be placed below the title and category. This option
                                        will focus your
                    ...
                    <li>
                        <label for="expresscurate_curated_text" class="title"><?php _e('Attribution Text For Original Article Link<span
            ...
            in the box below and you curate from google.com, "Curated from google.com" will appear at the bottom of your post'); ?>.</span>
                    ...
                    <li>
                        <p class="title"><?php _e('Open Original Article Link in a New Window/Tab'); ?><span scope="row"
                                                                                             class="description  "><?php _e('
            Select "Yes" if you want the original article link to be opened in a New Window/Tab. Select "No" if you want the link to be opened in the Same Window/Tab (default behavior).'); ?>
                    ...
                    <li>
                        <label for="expresscurate_max_tags" class="title"><?php _e('Max Number of Auto-suggested Tags');?><span
                                class="description">&nbsp;&nbsp; <?php _e('The recommended value is 3.'); ?><br/>
        <span><?php _e('ExpressCurate can auto-suggest tags for your post. It is based on the keywords and tags defined in your prior WordPress blogs. Enter the max number of auto-suggested tags you would like to have in each curated posts.'); ?></span>
                        </label>
                    ...
                    <li>
                        <label for="expresscurate_autosummary" class="title"><?php _e('Number of Curated Paragraphs'); ?><span
                                class="description  "><?php _e('Pick the number of paragraphs to be inserted from the original article into your post.'); ?></span>
                            <br/><span>&nbsp;&nbsp; <?php _e('The default value is 5');?></span></label>
                    ...
                    <li>
                        <p class="title"><?php _e('Enable ExpressCurate Blockquote'); ?><span class="description  ">
            <?php _e('Select "Yes" to use ExpressCurate blockquote for marking the original content quote. Select "No" if you are already using a theme that has a good enough quote style and ExpressCurate won\'t override it.');?>
          </span></p>
                    ...
                    <li>
                        <p class="title"><?php _e('SEO Enhancements'); ?><span scope="row" class="description  ">
            <?php _e('Click on "Yes" to enable ExpressCurate SEO enhancements for your curated post.'); ?>
          </span></p>
                    ...
                    <li>
                        ...
                        ?> />">
                            <label for="expresscurate_publusher" class="title"><?php _e('Publisher (Google+)'); ?><span
                                    class="description  "><?php _e('You can link content you publish on this blog to your company or personal Google+ profile.'); ?>
                <a href="https://plus.google.com/authorship" target="_blank"><?php _e('More Info'); ?></a>.</label></span>
                            ...
                            <a class="expresscurateLink verifyPublisherLink expresscurate_marginleft10"
                               ...
                               target="_blank"><?php _e('Verify publisher'); ?></a>
                            <br/>
                            <label for="expresscurate_publisher_twitter" class="title"><?php _e('Publisher (Twitter)'); ?><span
                                    class="description  "><?php _e('You can link content you publish on this blog to your company or personal Twitter profile.'); ?>
                <a href="https://plus.google.com/authorship" target="_blank"><?php _e('More Info'); ?></a>.</label></span>
                            ...
                            <br/>
                            <label for="expresscurate_publisher_facebook" class="title"><?php _e('Publisher (Facebook)'); ?><span
                                    class="description  "><?php _e('You can link content you publish on this blog to your company or personal Facebook profile.');?>
                <a href="https://plus.google.com/authorship" target="_blank">More Info</a>.</label></span>

                            <input class="controls" type="text" id="expresscurate_publisher_facebook" size="50"
                                   value="<?php
                                   if (get_option('expresscurate_publisher_facebook')) {
                                       echo get_option('expresscurate_publisher_facebook');
                                   } else {
                                       echo '';
                                   }
                                   ?>" name="expresscurate_publisher_facebook" placeholder=""/>
                        </div>
                    </li>
                    <li>
                        <p class="title"><?php _e('Auto Hashtagging'); ?><span class="description  ">
            <?php _e('Transform words starting with # into tags and add # to the words previously defined as tags.'); ?>
          </span></p>
                        <?php
                    ...
                    <li>
                        <p class="title"><?php _e('Your Keyword Tags'); ?><span class="description  ">
            <?php _e('Enter your target keywords that you want to be tagged in the post.  Multiple keywords need to be separated by commas.'); ?>
            <br/><?php _e('When this list is defined, ExpressCurate will look for these words in curated content and try to tag them in the article, as well as create links from these keywords that show up on tag\'s page.'); ?></span>
                        </p>
                        <a class="expresscurateLink" href="admin.php?page=expresscurate_keywords"><?php _e('Keywords Dashboard'); ?></a>
                    </li>
                    <!-- Number of posts  -->
                    <li>
                        <p class="title"> <?php _e('Keyword Statistics.'); ?>
    ...
    <div id="tab-2" class="tab-content">
        <div>
            <form class="expresscurate_marginTop20" id="smartPublishingSettingsTab" method="post" action="options.php">
                ...
                <ul>
                    <li>
                        <p class="title"><?php _e('Smart publishing '); ?></p>
                        ...
                        <div id="smartPublishingWrap" class="<?php echo $show_interval; ?>">
                            ...
                            <p class="title"><?php _e('Manually approve posts for smart publishing'); ?></p>
                            <?php
                            ...
                            <p class="title" for="expresscurate_hours_interval"><?php _e('Publish draft
                                articles'); ?></p>
                    ...
                    <li>
                        <p class="title"><?php _e('Social publishing '); ?></p>
    ...
    <div id="tab-4" class="tab-content">
        <div>
            <form class="expresscurate_marginTop20" method="post" action="options.php">
                ...
                <ul>
                    <li>
                        <p class="title"><?php _e('Default Category for Curated Posts'); ?><span class="description  "><?php _e('Please pick a default category for your curated posts from the list below. This will prevent a default "Uncategorized" being assigned to your post automatically.'); ?></span>
                        </p>
                    ...
                    <li>
                        <p class="title"><?php _e('Post type for ExpressCurate Chrome Extension'); ?><span class="description  "><?php _e('Please pick a post type for your curated posts from the list below. This will allow custom post types when curating with ExpressCurate Chrome Extension.'); ?></span>
                        </p>
                    ...
                    <li>
                        <p class="title"><?php _e('Publishing Directly from ExpressCurate Chrome Extension'); ?><span
                                class="description  "><?php _e('This setting gives you an option to save your curated post as a draft or publish it when you click on the "Curate" button on ExpressCurate Chrome extension.'); ?></span>
                        </p>
        ...
        <div>
            <form class="expresscurate_marginTop20" method="post" action="options.php">
                ...
                <ul>
                    <li>
                        <div class="title">
<?php _e('Content Pull Frequency'); ?>
                            <div class="description">
<?php _e('How frequently should ExpressCurate pull content (from RSS feeds, Alerts, etc) into your'); ?>
                                <a href="#"><?php _e('Content Feed'); ?></a>?
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="title">
<?php _e('Stop Keywords'); ?>
                            <div class="description">
<?php _e(' ExpressCurate will filter out the posts that contain any stop keywords.'); ?>
                            </div>
                        </div>
                        <div class="controls">
                    ...
                    <li>
                        <div class="title">
<?php _e('Keyword Match Email Alerts'); ?>
                            <div class="description">
<?php _e('Would you like to receive email alerts when keyword matches are found in your '); ?><a
                                    href="#"><?php _e('Content Feed'); ?></a>?
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <li>
                            <div class="title">
<?php _e('Content Alert Frequency'); ?>
                                <div class="description">
<?php _e('How frequently should ExpressCurate send content Alert Emails (from RSS feeds,
                                    Alerts,
                                    etc)'); ?>
                                </div>
                            </div>
...
<?php _e('Users'); ?>
                                <div class="description">
<?php _e('Define who should get content alerts.'); ?>
                                </div>
                            </div>
                            <div class="controls">
